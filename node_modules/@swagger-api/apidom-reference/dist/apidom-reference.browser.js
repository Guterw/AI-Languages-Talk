...
/* harmony export */ });
/* harmony import */ var stampit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8357);
...
const Reference = stampit__WEBPACK_IMPORTED_MODULE_0___default()({
  props: {
    uri: '',
    value: null,
    depth: 0,
...
/* harmony import */ var stampit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8357);
/* harmony import */ var stampit__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(stampit__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var ramda__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6352);
/* harmony import */ var ramda_adjunct__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9309);
/* harmony import */ var ramda_adjunct__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2139);



const ReferenceSet = stampit__WEBPACK_IMPORTED_MODULE_0___default()({
  props: {
    rootRef: null,
    refs: [],
    circular: false
  ...
  methods: {
    ...
    has(thing) {
      const uri = (0,ramda_adjunct__WEBPACK_IMPORTED_MODULE_1__["default"])(thing) ? thing : thing.uri;
      return (0,ramda_adjunct__WEBPACK_IMPORTED_MODULE_2__["default"])(this.find((0,ramda__WEBPACK_IMPORTED_MODULE_3__["default"])(uri, 'uri')));
    },
    find(callback) {
...
/* harmony import */ var _util_File__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8917);
...
const bundle = async (uri, options) => {
  ...
  const file = (0,_util_File__WEBPACK_IMPORTED_MODULE_4__["default"])({
...
const BundleStrategy = stampit__WEBPACK_IMPORTED_MODULE_0___default()({
  props: {
    name: null
  },
  methods: {
    ...
    async bundle() {
      throw new _swagger_api_apidom_error__WEBPACK_IMPORTED_MODULE_1__["default"]('bundle method in BundleStrategy stamp is not yet implemented.');
    }
  }
});
...
/* harmony import */ var _util_File__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8917);
...
const dereferenceApiDOM = async (element, options) => {
  ...
  const file = (0,_util_File__WEBPACK_IMPORTED_MODULE_3__["default"])({
...
const DereferenceStrategy = stampit__WEBPACK_IMPORTED_MODULE_0___default()({
  props: {
    name: null
  },
  methods: {
    ...
    async dereference() {
      throw new _swagger_api_apidom_error__WEBPACK_IMPORTED_MODULE_1__["default"]('dereference method in DereferenceStrategy stamp is not yet implemented.');
    }
  }
});
...
/* harmony import */ var ramda_adjunct__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4382);
...
const parse = async (uri, options) => {
  ...
  return parseFile((0,_util_File__WEBPACK_IMPORTED_MODULE_4__["default"])({
    ...file,
    data
  }), options);
};
...
const Parser = stampit__WEBPACK_IMPORTED_MODULE_0___default()({
  props: {
    name: '',
    /**
  ...
  methods: {
    async canParse() {
      throw new _swagger_api_apidom_error__WEBPACK_IMPORTED_MODULE_1__["default"]('canParse method in Parser stamp is not yet implemented.');
    },
    async parse() {
      throw new _swagger_api_apidom_error__WEBPACK_IMPORTED_MODULE_1__["default"]('parse method in Parser stamp is not yet implemented.');
    }
  }
});
...
/* harmony import */ var stampit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8357);
/* harmony import */ var stampit__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(stampit__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _swagger_api_apidom_error__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4909);
/* harmony import */ var _Resolver__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9059);
/* harmony import */ var _util_url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(658);




const HttpResolver = stampit__WEBPACK_IMPORTED_MODULE_0___default()(_Resolver__WEBPACK_IMPORTED_MODULE_1__["default"], {
  props: {
    timeout: 5000,
    redirects: 5,
  ...
  methods: {
    canRead(file) {
      return _util_url__WEBPACK_IMPORTED_MODULE_2__.isHttpUrl(file.uri);
    },
    async read() {
      throw new _swagger_api_apidom_error__WEBPACK_IMPORTED_MODULE_3__["default"]('read method in HttpResolver stamp is not yet implemented.');
    },
    getHttpClient() {
      throw new _swagger_api_apidom_error__WEBPACK_IMPORTED_MODULE_3__["default"]('getHttpClient method in HttpResolver stamp is not yet implemented.');
    }
  }
});
...
const Resolver = stampit__WEBPACK_IMPORTED_MODULE_0___default()({
  props: {
    name: null
  },
  methods: {
    ...
    async read() {
      throw new _swagger_api_apidom_error__WEBPACK_IMPORTED_MODULE_1__["default"]('read method in Resolver stamp is not yet implemented.');
    }
  }
});
...
const ResolveStrategy = stampit__WEBPACK_IMPORTED_MODULE_0___default()({
  props: {
    name: null
  },
  methods: {
    ...
    async resolve() {
      throw new _swagger_api_apidom_error__WEBPACK_IMPORTED_MODULE_1__["default"]('resolve method in ResolveStrategy stamp is not yet implemented.');
    }
  }
});
...
/* harmony import */ var ramda_adjunct__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9309);
/* harmony import */ var _url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(658);
...
const File = stampit__WEBPACK_IMPORTED_MODULE_0___default()({
  props: {
    uri: null,
    mediaType: 'text/plain',
    data: null,
  ...
  methods: {
    get extension() {
      if ((0,ramda_adjunct__WEBPACK_IMPORTED_MODULE_1__["default"])(this.uri)) {
        return _url__WEBPACK_IMPORTED_MODULE_2__.getExtension(this.uri);
      }
      return '';
    },
    toString() {
      ...
      if (this.data instanceof ArrayBuffer || ['ArrayBuffer'].includes((0,ramda__WEBPACK_IMPORTED_MODULE_3__["default"])(this.data)) || ArrayBuffer.isView(this.data)) {
...
/* harmony export */ });
/* harmony import */ var ramda_adjunct__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1465);
...
/* harmony import */ var ramda_adjunct__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9246);
/* harmony import */ var ramda_adjunct__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(2139);
/* harmony import */ var ramda_adjunct__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(2350);
/* harmony import */ var ramda_adjunct__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(8667);
...
/* harmony import */ var _isString__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9309);
 ...
 */
var escapeRegExp = (0,ramda__WEBPACK_IMPORTED_MODULE_0__["default"])(_isString__WEBPACK_IMPORTED_MODULE_1__["default"], (0,ramda__WEBPACK_IMPORTED_MODULE_2__["default"])(/[.*+?^${}()|[\]\\-]/g, '\\$&'));
...
/* harmony export */ });
/* harmony import */ var ramda__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8675);
/* harmony import */ var _isRegExp__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2141);
/* harmony import */ var _escapeRegExp__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(202);
...
var replaceAll = function replaceAll(searchValue, replaceValue, str) {
  ...
  var regexp = new RegExp((0,_isRegExp__WEBPACK_IMPORTED_MODULE_0__["default"])(searchValue) ? searchValue : (0,_escapeRegExp__WEBPACK_IMPORTED_MODULE_1__["default"])(searchValue), 'g');
...
/* harmony import */ var _isFunction__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4340);
/* harmony import */ var _internal_ponyfills_String_replaceAll__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6205);



var replaceAllPonyfill = (0,ramda__WEBPACK_IMPORTED_MODULE_0__["default"])(3, _internal_ponyfills_String_replaceAll__WEBPACK_IMPORTED_MODULE_1__["default"]);
 ...
 */
var replaceAll = (0,_isFunction__WEBPACK_IMPORTED_MODULE_3__["default"])(String.prototype.replaceAll) ? replaceAllInvoker : replaceAllPonyfill;
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (replaceAll);
...
/* harmony export */   BundleStrategy: () => (/* reexport safe */ _bundle_strategies_BundleStrategy__WEBPACK_IMPORTED_MODULE_8__["default"]),
/* harmony export */   DereferenceAncestorLineage: () => (/* reexport safe */ _dereference_util__WEBPACK_IMPORTED_MODULE_7__.AncestorLineage),
/* harmony export */   DereferenceError: () => (/* reexport safe */ _errors_DereferenceError__WEBPACK_IMPORTED_MODULE_16__["default"]),
/* harmony export */   DereferenceStrategy: () => (/* reexport safe */ _dereference_strategies_DereferenceStrategy__WEBPACK_IMPORTED_MODULE_6__["default"]),
...
/* harmony export */   File: () => (/* reexport safe */ _util_File__WEBPACK_IMPORTED_MODULE_1__["default"]),
/* harmony export */   HttpResolver: () => (/* reexport safe */ _resolve_resolvers_HttpResolver__WEBPACK_IMPORTED_MODULE_4__["default"]),
...
/* harmony export */   Parser: () => (/* reexport safe */ _parse_parsers_Parser__WEBPACK_IMPORTED_MODULE_2__["default"]),
...
/* harmony export */   ResolveStrategy: () => (/* reexport safe */ _resolve_strategies_ResolveStrategy__WEBPACK_IMPORTED_MODULE_5__["default"]),
/* harmony export */   Resolver: () => (/* reexport safe */ _resolve_resolvers_Resolver__WEBPACK_IMPORTED_MODULE_3__["default"]),
...
/* harmony export */   dereferenceApiDOM: () => (/* binding */ dereferenceApiDOM),
/* harmony export */   mergeOptions: () => (/* reexport safe */ _options_util__WEBPACK_IMPORTED_MODULE_10__.merge),
/* harmony export */   options: () => (/* reexport safe */ _options__WEBPACK_IMPORTED_MODULE_9__["default"]),
...
/* harmony export */ });
/* harmony import */ var _util_File__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8917);
/* harmony import */ var _util_url__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(658);
/* harmony import */ var _options__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(8363);
/* harmony import */ var _options_util__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(6547);
...
/* harmony import */ var _parse_parsers_Parser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3166);
/* harmony import */ var _resolve_resolvers_Resolver__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9059);
/* harmony import */ var _resolve_resolvers_HttpResolver__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5923);
/* harmony import */ var _resolve_strategies_ResolveStrategy__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7758);
/* harmony import */ var _dereference_strategies_DereferenceStrategy__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(978);
/* harmony import */ var _dereference_util__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3429);
/* harmony import */ var _bundle_strategies_BundleStrategy__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(5508);
...
const readFile = async (uri, options = {}) => {
  const mergedOptions = (0,_options_util__WEBPACK_IMPORTED_MODULE_10__.merge)(_options__WEBPACK_IMPORTED_MODULE_9__["default"], options);
  const file = (0,_util_File__WEBPACK_IMPORTED_MODULE_1__["default"])({
