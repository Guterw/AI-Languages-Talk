...
const OpenApi3_0DereferenceVisitor = (0, _stampit.default)({
  ...
  methods: {
    ...
    async toReference(uri) {
      ...
      const mutableReference = (0, _Reference.default)({
        uri: baseURI,
      ...
      if (this.options.dereference.immutable) {
        ...
        const immutableReference = (0, _Reference.default)({
    ...
    async ReferenceElement(referencingElement, key, parent, path, ancestors) {
      ...
      if (ancestorsLineage.includes(referencedElement)) {
        ...
        if (this.options.dereference.circular === 'error') {
          ...
          const replacer = (_this$options$derefer = (_this$options$derefer2 = this.options.dereference.strategyOpts['openapi-3-0']) == null ? void 0 : _this$options$derefer2.circularReplacer) != null ? _this$options$derefer : this.options.dereference.circularReplacer;
       ...
       */
      if ((isExternalReference || (0, _apidomNsOpenapi.isReferenceElement)(referencedElement) || ['error', 'replace'].includes(this.options.dereference.circular)) && !ancestorsLineage.includesCycle(referencedElement)) {
    ...
    async PathItemElement(referencingElement, key, parent, path, ancestors) {
      ...
      if (ancestorsLineage.includes(referencedElement)) {
        ...
        if (this.options.dereference.circular === 'error') {
          ...
          const replacer = (_this$options$derefer3 = (_this$options$derefer4 = this.options.dereference.strategyOpts['openapi-3-0']) == null ? void 0 : _this$options$derefer4.circularReplacer) != null ? _this$options$derefer3 : this.options.dereference.circularReplacer;
          const replacement = replacer(refElement);
          if ((0, _apidomCore.isMemberElement)(parent)) {
            parent.value = replacement; // eslint-disable-line no-param-reassign
          } else if (Array.isArray(parent)) {
       ...
       *  3. We are dereferencing the fragment lazily/eagerly depending on circular mode
       */
      if ((isExternalReference || (0, _apidomNsOpenapi.isPathItemElement)(referencedElement) && (0, _apidomCore.isStringElement)(referencedElement.$ref) || ['error', 'replace'].includes(this.options.dereference.circular)) && !ancestorsLineage.includesCycle(referencedElement)) {
        // append referencing reference to ancestors lineage
        directAncestors.add(referencingElement);
        const visitor = OpenApi3_0DereferenceVisitor({
          reference,
    ...
    async LinkElement(linkElement, key, parent) {
      ...
      if ((0, _apidomCore.isStringElement)(linkElement.operationRef)) {
        ...
        // possibly non-semantic referenced element
        const jsonPointer = (0, _apidomJsonPointer.uriToPointer)((0, _apidomCore.toValue)(linkElement.operationRef));
